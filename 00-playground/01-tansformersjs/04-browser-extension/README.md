...
An example project to show how to run Transformers.js in a browser extension.
...
1. Clone the repo and enter the project directory:
   ...
   cd 00-playground/01-tansformersjs/04-browser-extension
   ```
...
Based on [Building a browser extension](https://huggingface.co/docs/transformers.js/tutorials/browser-extension) by Transformers.js (2023).
